export const promptVersion = 'v7.1-lebuda-cmc-stable-no-calibration-2026-07-01';
...
- Give holistic_score 6 only when originality, usefulness, and elaboration are all strong.
